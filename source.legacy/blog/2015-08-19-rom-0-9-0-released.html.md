...
For notes about upgrading to ROM 0.9.0 please refer to [Upgrade Guides](https://github.com/taqtiqa/ramets/wiki/Upgrade-Guides).

Gem updates summary:

- rom 0.9.0 [CHANGELOG](https://github.com/taqtiqa/ramets/blob/main/CHANGELOG.md#v090-2015-08-19)
- rom-sql 0.6.0 [CHANGELOG](https://github.com/taqtiqa/ramets-sql/blob/main/CHANGELOG.md#v060-2015-08-19)
- rom-yaml 0.2.0 [CHANGELOG](https://github.com/taqtiqa/ramets-yaml/blob/main/CHANGELOG.md#v020-2015-08-19)
- rom-csv 0.2.0 [CHANGELOG](https://github.com/taqtiqa/ramets-csv/blob/main/CHANGELOG.md#v020-2015-08-19)
- rom-rails 0.5.0 [CHANGELOG](https://github.com/taqtiqa/ramets-rails/blob/main/CHANGELOG.md#v050-2015-08-19)
- rom-lotus 0.2.0 [CHANGELOG](https://github.com/taqtiqa/ramets-lotus/blob/main/CHANGELOG.md#v020-2015-08-19)
- rom-roda 0.2.0 [CHANGELOG](https://github.com/taqtiqa/ramets-roda/blob/main/CHANGELOG.md#v020-2015-08-19)

New gems:

- [rom-repository](https://github.com/taqtiqa/ramets-repository) 0.1.0 - a higher-level interface with auto-mapping and additional relation plugins
- [rom-mapper](https://github.com/taqtiqa/ramets-mapper) 0.1.1 - standalone mapper objects extracted from rom
- [rom-model](https://github.com/taqtiqa/ramets-model) 0.1.1 - extracted from rom-rails, includes `Attributes` and `Validator` extensions
- [rom-support](https://github.com/taqtiqa/ramets-support) 0.1.0 - a bunch of small extensions reused across all rom gems

New adapters:

- [rom-couchdb](https://github.com/taqtiqa/ramets-couchdb) - an adapter for CouchDB
- [rom-http](http://github.com/taqtiqa/ramets-http) - an abstract HTTP adapter useful for implementing concrete adapters for HTTP APIs
- [rom-rethinkdb](http://github.com/taqtiqa/ramets-rethinkdb) - an adapter for RethinkDB
...
Global setup process still works, but please refer to [upgrade guide](https://github.com/taqtiqa/ramets/wiki/Upgrade-Guides) if you are using ROM standalone without any framework integration.
...
A couple of useful extensions have been extracted from the rom-rails gem into rom-model. These are standalone components that are based on Virtus and ActiveModel. We have an ambitious plan to rewrite it in the future on top of more powerful tools. Please refer to rom-model [README](https://github.com/taqtiqa/ramets-model#rommodel) for more information.
...
As announced [a couple of weeks ago](https://github.com/taqtiqa/ramets-model#rommodel), we're running a campaign for [sustainable development](http://salt.bountysource.com/teams/rom-rb). We already have people who've decided to donate - thank you **so much** for your support.
...
All repositories now have their own issue trackers enabled on GitHub. If you find a bug, or have problems using ROM, please report an issue for a specific project. If you're not sure which project it relates to, just report it in the main [rom issue tracker](https://github.com/taqtiqa/ramets/issues), and we'll move it to the right place if needed.
